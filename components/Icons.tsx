...
export const LayoutColumnsIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const ImagesIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M18 22H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h14l4 4v10a2 2 0 0 1-2 2Z"></path>
        <path d="M14 2v4h4"></path>
        <path d="M10.4 12.6a2 2 0 0 1 3.2 0L16 16"></path>
        <path d="m4 16 3-3a2 2 0 0 1 3 0l.4.4"></path>
...
export const WandIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M5 21L9 17"></path>
    <path d="M21 15l-4.5 4.5"></path>
    <path d="M11 2.2c-2 .5-3.8 1.4-5.2 2.8C2.2 8.6 2.2 15.4 5.8 19s10.4 3.6 13.8.2c.2-.2.3-.4.5-.6"></path>
    <path d="M20.8 11c-.5-2-1.4-3.8-2.8-5.2"></path>
  </svg>
);
...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48px" height="48px">
        ...
        <path fill="#4CAF50" d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.223,0-9.657-3.657-11.303-8H24v-8H24V20H42v-0.083c0.138,1.309,0.223,2.65,0.223,4.083c0,11.045-8.955,20-20,20C24,44,24,44,24,44z" />
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.23,4.168-4.08,5.574l6.19,5.238C39.99,36.506,44,30.836,44,24C44,22.659,43.862,21.35,43.611,20.083z" />
    </svg>
);
